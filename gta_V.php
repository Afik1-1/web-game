...
<head>
    ...
    <title>GTA V Download | Game App | Game Website Using Html Css And Javascript</title>
</head>
            ...
            <div class="download_realted_box">
                <div class="download_box">
                    <div class="img_video_bx">
                        <h6 id="img_change"></h6>
                        <video src="video/gta_V.mp4" id="video"></video>
                    </div>
                    <h4>Requirememt</h4>
                    <ul>
                        <li><i class="bi bi-pc-horizontal"></i> 64-bit Windows 7, 8.1, 10, 11</li>
                        <li><i class="bi bi-cpu"></i> Core i5 7th Generation</li>
                        <li><i class="bi bi-gpu-card"></i> 4GB Graphics Card</li>
                        <li><i class="bi bi-memory"></i> Minimum 8GB Memory(Ram) </li>
                        <li><i class="bi bi-hdd-fill"></i> Minimum 100GB Disk Memory</li>
                        <li><i class="bi bi-pci-card"></i> Installed Open GL</li>
                        <li><i class="bi bi-reception-4"></i> A broadband Internet connection(for Multiplayer)</li>
                        <li><i class="bi bi-x-circle-fill"></i> Installed Direct X Any Version</li>
                    </ul>
                    <div class="btns">
                        <a href="#"><i class="bi bi-hdd-fill"></i> 50.0GB</a>
                        <a href="#" id="play"><i class="bi bi-play-fill"></i> Play</a>
                        <a href="Download/gta v .zip" download="gta V"><i class="bi bi-cloud-arrow-down-fill"></i> Download</a>
                    </div>
                </div>
