...
const change_img_data = () => {
    setTimeout(() => {
        img_change.style.background = "url('img/gta v 1.jpg') no-repeat center center/cover";
    }, 3000);
    setTimeout(() => {
        img_change.style.background = "url('img/gta v 2.jpg') no-repeat center center/cover";
    }, 3000);
    setTimeout(() => {
        img_change.style.background = "url('img/gta v 3.jpg') no-repeat center center/cover";
    }, 6000);
}
